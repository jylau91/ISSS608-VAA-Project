...
## Key evidence missing from TROUT – case of **Simone Kat**
...
Without these, TROUT leaves Simone looking inactive. Including FILAH and Journalist flips the picture: she emerges as the board’s principal advocate for community-oriented tourism. The omission therefore materially understates her contribution and skews any assessment of board balance.
...
The integrated analysis of the COOTEFOO knowledge-graph datasets shows a consistent, statistically supported bias in favour of tourism over fishing. Across topics, datasets and individual board members, mean sentiment towards tourism is higher, a pattern confirmed by ANOVA, Kruskal-Wallis, robust and Bayesian tests. The fishing‐favourable picture suggested by TROUT alone is not borne out once FILAH and the Journalist notes are added, illustrating the danger of drawing conclusions from incomplete evidence. Including all sources brings to light positive tourism statements, particularly for members such as Simone Kat and Seal, and exposes selective omissions in advocacy-group records. Visual checks, for example heatmaps and geo-linked network views, reinforce these statistical findings and demonstrate how data integration produces a more balanced understanding of committee dynamics.

**Key findings**

-   Tourism sentiment dominates every comparative slice, by topic, by dataset and by member.

-   The tourism advantage is statistically significant under multiple confirmatory tests, whereas TROUT’s apparent fishing bias is not.

-   Data completeness matters: FILAH and Journalist records add positive tourism sentiment that TROUT omits, correcting the narrative.

-   Member-level inspection reveals selective gaps, for example the absence of Ed Helpsford in FILAH, illustrating how sampling bias can distort personal profiles.

-   Mapping and sentiment heatmaps provide spatial and relational context, grounding numerical results in clear visual evidence.
